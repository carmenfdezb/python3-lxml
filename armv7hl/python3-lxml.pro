...
DISTFILES += \
    src/lxml/html/clean.cpython-37m-arm-linux-gnueabihf.so \
    src/lxml/html/diff.cpython-37m-arm-linux-gnueabihf.so \
    src/lxml/_elementpath.cpython-37m-arm-linux-gnueabihf.so \
    src/lxml/builder.cpython-37m-arm-linux-gnueabihf.so \
    src/lxml/etree.cpython-37m-arm-linux-gnueabihf.so \
    src/lxml/objectify.cpython-37m-arm-linux-gnueabihf.so \
    src/lxml/sax.cpython-37m-arm-linux-gnueabihf.so \
